...
@router.post("/api/destinations/", response_model=Destination)
...
@router.get("/api/destinations/{destination_id}", response_model=Destination)
...
@router.put("/api/destinations/{destination_id}", response_model=Destination)
